...
class SalesSapPostedSheets implements FromView,WithTitle
{
    ...
    public function view(): View
    {
        ...
        return view('reports.sales.excels.sales-sap-posted', ['sales_sap_posted' => $results]);
    }
}
